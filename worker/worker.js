...
const GEMINI_RENDER_PROMPT = [
  ...
  '- Si en el diseño de referencia hay partes en color NEGRO, esas partes deben renderizarse en neón BLANCO FRÍO (no existe neón LED negro físicamente).',
  '- Para el resto de los colores: respetá fielmente lo que tenga la referencia, pero entendido como "color de la luz del neón", no como pintura.',
  '',
  ...
  'Si en el contexto vienen NOTAS / INSTRUCCIONES ESPECÍFICAS, aplicalas al render (color, tipografía, agregados, estilo, etc.).',
  'EXCEPCIONES que NO pueden ser sobreescritas por las notas:',
  '- Materiales: siempre neón 6mm + acrílico transparente.',
  '- Vista frontal recta, nunca perspectiva.',
  '- Negro → blanco frío, salvo que las notas digan explícitamente otro color para esas partes.'
].join('\n');
