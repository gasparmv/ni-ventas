...
const GEMINI_RENDER_PROMPT = [
  ...
  '',
  'PROHIBIDO en el render (no existen físicamente en el producto):',
  '- Vinilo, calcomanías, pintura, impresión.',
  '- Paneles LED, pantallas, módulos digitales.',
  '- Rellenos sólidos de color en zonas grandes (todo color sale de la manguera de neón en sí, no de fondos pintados).',
  '- Texturas, sombreados internos, degradados pintados dentro de las letras o figuras.',
  '- Cualquier material que no sea neón 6mm o acrílico transparente.',
  'Si el diseño de referencia tiene rellenos sólidos, degradados o detalles internos, traducilos al render como contornos de neón solamente (outline). El interior de las letras y figuras queda transparente (se ve el acrílico).',
  '',
  '═══ VISTA / CÁMARA ═══',
...
const GEMINI_PARAMS_PROMPT = (contextoCliente) => [
  ...
  '',
  '═══ PASO 3: ESTIMAR neon_mt ═══',
  'Longitud total de la manguera de neón = perímetro de las líneas del diseño escalado a las medidas elegidas.',
  '- Palabra cursiva: ~0.4-0.6 mt por letra (depende del tamaño).',
  '- Letras block/sans-serif: ~0.2-0.3 mt por letra.',
  '- Logos con figuras (estrellas, formas, elementos decorativos): sumá el perímetro de cada elemento individual.',
  '- Escalá proporcionalmente a las medidas reales: un diseño de 30cm vs 100cm de ancho tiene 3.3× más metros de neón.',
  '',
  '═══ PASO 4: VALIDACIÓN ═══',
  ...
  '{"ancho_cm": <entero>, "alto_cm": <entero>, "neon_mt": <decimal 1 lugar>, "razonamiento": "<frase breve mencionando el ratio de la imagen y cómo llegaste a las medidas>", "dif_vs_cliente": <true|false>}'
].join('\n');
