...
(function(){
  ...
  function guiaHtml(){
    ...
    h+='<p>La tira es de <b>primera generacion</b> con puntos de corte cada <b>2.5 cm</b> &mdash; por eso el diseno se divide en "tramos". El <b>cableado va disimulado por los laterales</b>, queda prolijo.</p>';
    ...
    h+='<ul>';
    h+='<li><b>Exterior / sol y lluvia:</b> los sellamos con <b>silicona fria (tipo Fastix)</b> para impermeabilizarlos &mdash; no silicona caliente, que con el calor se despega. Igual conviene que no le pegue el <b>sol directo</b> todo el dia (el sol termina degradando la tira) y, si esta bajo alero, mejor.</li>';
    h+='<li><b>Consumo y enchufe:</b> es LED, bajo consumo y larga vida. La tira trabaja a <b>12V</b> y viene con su <b>fuente/transformador</b>, que se enchufa a 220V como cualquier electrodomestico.</li>';
    ...
    h+='<p><b>Que son los "tramos":</b> son los cortes o subtrazos del diseno (cada trazo suelto del vector). Cada tramo es una soldadura mas, o sea mas mano de obra &mdash; por eso encarecen. Contalos bien.</p>';
    ...
    h+='<h3>Velocidad</h3>';
    h+='<p>Manda el presupuesto <b>en ~5 minutos</b>, mientras el cliente esta caliente &mdash; si lo dejas 3 horas, despues no te contesta. Cuando te piden ejemplos, <b>manda una foto</b> de trabajos tuyos; no los mandes "a mi perfil" (se cuelgan y se van).</p>';
    h+='<h3>Seguimiento: el que no sigue, pierde</h3>';
    h+='<p>Se cierra <b>~1 de cada 10 presupuestos</b>, muchas veces despues de varios contactos. No tengas verguenza de insistir:</p>';
    ...
    h+='<p>El que dice "mas adelante" no es un descarte: guardalo y reescribile en ~1 mes. Y ojo &mdash; el que transmite mas urgencia suele ser el que menos paga; los que se toman su tiempo y vuelven con cambios cierran mas.</p>';
    ...
    h+='<h3>Post-venta</h3>';
    h+='<p>Cuando entregas: "si subis una foto o historia etiquetandonos, te hago 10% de descuento en el proximo pedido". Te consigue material y recompra.</p>';
    h+='<p><b>Si el cliente no sabe que color o base elegir:</b> anda a lo seguro &mdash; <b>blanco frio</b> y <b>base transparente</b> son por lejos los mas pedidos.</p>';
    ...
    h+='<h3>Objecion: "es un plastico con una manguera de luz, no puede costar tanto"</h3>';
    h+='<p>No pidas disculpas por el precio. Explica el <b>servicio completo</b>: diseno personalizado, materiales premium (acrilico + neon LED), el vectorizado y la fabricacion a medida, y el tiempo invertido. No es un producto de gondola, es a medida.</p>';
