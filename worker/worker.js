...
const GEMINI_RENDER_PROMPT = [
  ...
  'El neón LED tiene limitaciones físicas reales que el diseño debe respetar. Aplicá estos criterios de síntesis cuando adaptes la referencia:',
  '',
  ...
  '',
  '3. ELEMENTOS A ELIMINAR (no se pueden hacer en neón):',
  '   · Puntos sueltos / pixeles individuales / pequeños "destellos".',
  '   · Sparkles, brillos, "shines" tipo estrellas chiquitas decorativas.',
  '   · Partículas, polvo de estrellas, salpicaduras.',
  '   · Texturas, ruido, granulado.',
  '   · Sombras pintadas, glow interno, halos pintados (el glow real del render lo da la luz del neón en sí).',
  '',
  '4. ELEMENTOS A SIMPLIFICAR:',
  '   · Estrellas decorativas chiquitas → si son menores a 3cm, OMITILAS. Si son medianas/grandes, mantenelas como contorno de estrella simple.',
  '   · Detalles internos de figuras (chocolate con cuadrículas, líneas dentro de un objeto) → contorno exterior solo, eliminá el detalle interno si quedaría menor a 2cm.',
  '   · Múltiples elementos chiquitos similares → agruparlos en una forma más grande continua o eliminar los excedentes.',
  '   · Letras con doble outline (contorno y relleno de otro color) → una sola línea de contorno.',
  '',
  '5. SOLO CONTORNOS: el neón solo representa el contorno (outline) de cada forma. El interior de letras y figuras queda transparente (el acrílico).',
  '',
